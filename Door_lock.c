...
String tagUID = "29 B9 ED 23"; // String to store UID of tag. Change it with your 
tag's UID
...
void send_message(String message)
{
 ...
 delay(100);
 SIM900.println("AT+CMGS=\"+XXXXXXXXXXXX\""); // Replace it with your 
mobile number
 delay(100);
